...
// 그룹 목록/상세 조회
router.get('/groups', validateGroupQuery, getGroupsController); // 목록 조회
router.get('/groups/:id', validateID, getGroupByIdController); // 상세 조회
...
// 그룹 내 참가자 랭킹 조회
router.post('/groups/:id/rank', validateID, getGroupMemRankController);
